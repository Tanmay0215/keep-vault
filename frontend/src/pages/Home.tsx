                ...
                <div className="mx-auto max-w-2xl">
                    <div className="text-center">
                        ...
                        <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                            Keep Vault helps you organize your thoughts, ideas, and notes in a secure and modern way.
                        ...
                        <div className="mt-10 flex items-center justify-center gap-x-6">
                            ...
                            <Link to="/login" className="text-lg font-semibold leading-6 text-gray-900 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400">
                        ...
                        <dl className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-3">
                            <div className="flex flex-col">
                                ...
                                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                                    <p className="flex-auto">Your notes are encrypted and stored securely. Only you can access them.</p>
                                </dd>
                            </div>
                            <div className="flex flex-col">
                                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900 dark:text-white">
                                ...
                                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                                    <p className="flex-auto">Keep your notes organized with our intuitive interface and easy-to-use features.</p>
                                </dd>
                            </div>
                            <div className="flex flex-col">
                                <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-gray-900 dark:text-white">
                                ...
                                <dd className="mt-4 flex flex-auto flex-col text-base leading-7 text-gray-600 dark:text-gray-300">
                                    <p className="flex-auto">Your privacy is our priority. We never share your data with third parties.</p>
                                </dd>
                            </div>
                        </dl>
                    </div>
